...
@OCCASPartQueryRegistry.register_tag_handler(filter_type=OCCASPartTagType.SPECIES)
class OCSpeciesTagHandler(OCCASPartTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, cas_part: OCOutfitPart) -> Tuple[Any]:
        return tuple(cas_part.available_for.species)

    # noinspection PyMissingOrEmptyDocstring
    def applies(self, cas_part: OCOutfitPart) -> bool:
        return len(cas_part.available_for.species) > 0
