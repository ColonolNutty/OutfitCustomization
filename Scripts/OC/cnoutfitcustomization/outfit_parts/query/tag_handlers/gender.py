...
@OCCASPartQueryRegistry.register_tag_handler(filter_type=OCCASPartTagType.GENDER)
class OCGenderTagHandler(OCCASPartTagHandler):
    """ Tags. """

    # noinspection PyMissingOrEmptyDocstring
    def get_tags(self, cas_part: OCOutfitPart) -> Tuple[Any]:
        return tuple(cas_part.available_for.genders)

    # noinspection PyMissingOrEmptyDocstring
    def applies(self, cas_part: OCOutfitPart) -> bool:
        return len(cas_part.available_for.genders) > 0
